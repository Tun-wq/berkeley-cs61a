...
def is_swap(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    string_player_score = str(player_score)
    string_opponent_score = str(opponent_score)
    if (len(string_player_score) == 1):
        string_player_score = '0' + string_player_score
    if (len(string_opponent_score) == 1):
        string_opponent_score = '0' + string_opponent_score
    player_score_ones = int(string_player_score[-1])
    player_score_tens = int(string_player_score[-2])
    opponent_score_ones = int(string_opponent_score[-1])
    opponent_score_tens = int(string_opponent_score[-2])
    different = abs(player_score_ones - player_score_tens) - abs(opponent_score_ones - opponent_score_tens)
    if (different == 0):
        return True
    else:
        return False
